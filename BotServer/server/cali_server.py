...
HOST = ""    # La varible HOST est une chaine vide, ainsi la fonction bind() peut être connectée à n'importe quelle adresse IP valide
PORT = 21567
BUFSIZ = 1024       # La taille du Buffer
ADDR = (HOST, PORT)

tcpSerSock = socket(AF_INET, SOCK_STREAM)    # Creation d'un socket
tcpSerSock.bind(ADDR)    # Configurer l'adresse IP et le numéro de port du serveur
tcpSerSock.listen(5)     # Le nombre de connexion permise simultanément = 5 et les autres sont rejetées

busnum = 1          # Numéro du bus utilisé 0 pour Raspberry Zero, 1 pour Raspberry 1, ...
